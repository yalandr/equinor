...
// MODAL
let licenseModalCall = document.querySelectorAll(".license-modal-call");
let licenseModalClose = document.querySelector(".close-icon");
let licenseModal = document.querySelector(".license-modal");
let modalContent = document.querySelector(".modal-content");

for (let i=0; i<licenseModalCall.length; i++) {
    licenseModalCall[i].addEventListener('click', function() {
